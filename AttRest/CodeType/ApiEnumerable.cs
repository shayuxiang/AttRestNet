...
namespace AttRest.CodeType
{
    public class ApiEnumerable
    {
        ...
        public string ToSchema(string Host)
        {
            ...
            func = $@"<p class='title_p'>AttRest-Document:[{Host}]</p><ul class='enum_ul'>{func}</ul>";
            //定义对象
        ...
        public string GetDefaultCss() {
            #region Default-CSS
            var retcss = $@"<style type=""text/css"">
      *{{
            margin: 0;
            padding: 0;
            }}
            ...
            body {{
                font-family: ""Arial"",""Microsoft YaHei"",""宋体"",""宋体"",sans-serif;
                background: #112233;
            }}
    ...
    .enum_ul, .entity_ul, .func_ul {{
                padding-bottom: 30px;
            }}

        .enum_ul: after, .entity_ul: after, .func_ul: after {{
            content: "";
            display: block;
            width: 100%;
            height: 0px;
    ...
    .EnumDetail, .ModelDetail, .apiDesc {{
            width: 100%;
            display: block;
            font-weight: 300;
            font-size: 14px;
    ...
    .EnumParam, .ModelParam {{
            width: 100%;
            display: block;
            }}

    .ModelParam, .EnumParam {{
            padding:15px 0px;
                border-bottom: 1px solid #ededed;
    }}

        .ModelParam: after, .EnumParam: after, .apiParam: after {{
            content: "";
            display: block;
            width: 100%;
            height: 0px;
        ...
        .ModelParam > li, .EnumParam > li {{
            ...
            .ModelParam > li:nth-child(3), .EnumParam > li:nth - child(3) {{
            width: 40%;
            }}

            .ModelParam > li:nth-child(4), .EnumParam > li:nth - child(4) {{
            width: 10%;
            }}
